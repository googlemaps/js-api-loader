...
this.google.maps.plugins.loader = (function (exports) {
  ...
  var uncurryThis$f = NATIVE_BIND$2 && bind$6.bind(call$c, call$c);
  ...
  */
  ...
  if (!set || !clear) {
    ...
    } else if (global$a.addEventListener && isCallable$3(global$a.postMessage) && !global$a.importScripts && location && location.protocol !== 'file:' && !fails$1(post)) {
      defer = post;
